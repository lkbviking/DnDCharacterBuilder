...
import { item, feature, spell, feat, lineage, sixE } from '../links.js';
...
potentialCharacters.push(
    ...
    .setHasPlaytestMaterial(true)
    .setHasHomebrewMaterial(false)
    .setBuildDraw('The Siren is a fun build designed to make the most of the Bard\'s ability to learn spells from any class. Having ' + feature('Bardic Inspiration', 'bard') + ' (d12 at this level), ' + spell('Bless') + ', and ' + feature('Emboldening Bond', 'cleric:peace') + ' all at once is the foundation of your support powers which only requires a single prepared spell. Apart from that, you can customize your spell list to be whatever you like: either a variety of support spells such as are recommended below, or even take all damage spells and just provide the passive support from your ' + feature('Bardic Inspiration', 'bard') + ' (d12 at this level), ' + spell('Bless') + ', and ' + feature('Emboldening Bond', 'cleric:peace') + '.')
    ...
    .setMainClassGameplayDescription('Through ' + feature('Magical Secrets', 'bard') + ' and ' + feature('Magical Discoveries (bad link, 6e feature, basically the same as Magical Secrets)', 'bard') + ', you have access to a wide variety of spells, allowing you to adapt to any situation. Your spellcasting is your primary focus, and you have amongst the largest amount of prepared spells as well as access to all spells in the game. The power and draw of this character is that the only limit to your spellcasting is your imagination.')
    ...
    .setMultiClassSubClassGameplayDescription('Your cleric dip gives you access to the Peace Domain\'s ' + feature('Emboldening Bond', 'cleric:peace') + ' to further buff allies and medium armor proficiency to increase your survivability.')
    .setFeats(feat('Heavily Armored') + ', ' + feat('Resilient') + '(CON), and +1 CON/+1 CHA should be your first 3 ASIs. Next level you can take ' + feat('Inspiring Leader') + ' or +2 CHA.')
    .setRace(lineage('Aasimar') + ' for the extra healing option and flight. Sirens were canonically part woman and part bird so the winged/angelic Aasimar fit the theme and backstory of this character well. Pick which type of ' + lineage('Aasimar') + ' based on what alignment you want to play. Protector Aasimar is the best for this build, but Fallen and Scourge Aasimar work as well.')
