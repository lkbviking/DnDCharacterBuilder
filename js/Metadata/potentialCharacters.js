...
potentialCharacters.push(
    ...
    .setMagicItemsByTier(2, item('Broom of Flying') + ' AND ' + item('Pearl of Power'))
                                    // 12 6 - 12 6
    .setRecommendedSpellsByTier(1, ['Cure Wounds - Warlock', 'Guiding Bolt - Warlock', 'Healing Word - Consider for Twinning']) // 1 2
    ...
    .setRecommendedSpellsNotes('You can know 12 sorcerer/cleric spells and 6 warlock spells at this level. The above list consists of all 6 warlock spells and 8 of the sorcerer/cleric spells. Most of the recommended spells are staples but while adding your last 4 sorcerer/cleric spells feel free to swap out some of the recommended ones as well. Just remember that neither warlocks nor sorcerers can change their known spells so you want to have at least one tool for every situation.')
    .setOtherNotes('Consider instead of taking warlock levels taking 4 more levels of sorc and taking your first level as Order cleric. This is of course, complete dogshit but Andrew Shuler guarentees its the best build in the game and neither you nor any of your allies will ever die.')
    .addAffinityVector(new AffinityVector('TANK', NONE))
    .addAffinityVector(new AffinityVector('MELEE_DPS', NONE))
    .addAffinityVector(new AffinityVector('RANGED_DPS', NONE))
    .addAffinityVector(new AffinityVector('CASTER_DPS', VERY))
